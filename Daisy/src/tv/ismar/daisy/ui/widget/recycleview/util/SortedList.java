...
package tv.ismar.daisy.ui.widget.recycleview.util;
 ...
 * list
 * such that it can be bound to a {@link tv.ismar.daisy.ui.widget.recycleview.widget.RecyclerView.Adapter
...
public class SortedList<T> {
    ...
    public static abstract class Callback<T2> implements Comparator<T2> {
         ...
         * <p>
         * For example, if you are using SortedList with a {@link tv.ismar.daisy.ui.widget.recycleview.widget.RecyclerView.Adapter
