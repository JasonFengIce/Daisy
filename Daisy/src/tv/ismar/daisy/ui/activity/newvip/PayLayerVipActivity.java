...
public class PayLayerVipActivity extends BaseActivity implements OnHoverListener, View.OnFocusChangeListener {
    ...
    private void payLayerVip(String cpid) {
        NewVipHttpManager.getInstance().resetAdapter_SKY.create(NewVipHttpApi.PayLayerVip.class).doRequest("3", SimpleRestClient.device_token).enqueue(new Callback<PayLayerVipEntity>() {
            @Override
