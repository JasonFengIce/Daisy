...
public class SearchAdapter extends HGridAdapter<MovieBean> implements OnImageViewLoadListener {
	...
	public SearchAdapter(Context context, int sourceid) {
		this.mContext = context;
		this.sourceid = sourceid;
		this.mLayoutInflater = LayoutInflater.from(context);
	}

	public SearchAdapter(Context context, List<MovieBean> movieList, int sourceid) {
		this.mContext = context;
