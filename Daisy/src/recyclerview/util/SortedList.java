 ...
 * list
 * such that it can be bound to a {@link recyclerview.widget.RecyclerView.Adapter
...
public class SortedList<T> {
    ...
    public static abstract class Callback<T2> implements Comparator<T2> {
         ...
         * <p>
         * For example, if you are using SortedList with a {@link recyclerview.widget.RecyclerView.Adapter
