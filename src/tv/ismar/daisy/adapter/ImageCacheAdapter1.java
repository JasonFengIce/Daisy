...
public class ImageCacheAdapter1 extends HGridAdapter<MovieBean> implements OnImageViewLoadListener {
	...
	public ImageCacheAdapter1(Context context, int sourceid) {
		this.mContext = context;
		this.sourceid = sourceid;
		this.mLayoutInflater = LayoutInflater.from(context);
	}

	public ImageCacheAdapter1(Context context, List<MovieBean> movieList, int sourceid) {
		this.mContext = context;
