...
import com.activeandroid.util.ActiveLog;
    ...
    public ModelInfo(Configuration configuration) {
        if (!loadModelFromMetaData(configuration)) {
            try {
                ...
                ActiveLog.e("Couldn't open source path.", e);
            }
        }

        ActiveLog.i("ModelInfo loaded.");
    }
        ...
        if (typeSerializers != null) {
            for (Class<? extends TypeSerializer> typeSerializer : typeSerializers) {
                try {
                    ...
                    ActiveLog.e("Couldn't instantiate TypeSerializer.", e);
                } catch (IllegalAccessException e) {
                    ActiveLog.e("IllegalAccessException", e);
                }
            }
        }
    ...
    private void scanForModelClasses(File path, String packageName, ClassLoader classLoader) {
        if (path.isDirectory()) {
            ...
            try {
                ...
                ActiveLog.e("Couldn't create class.", e);
            } catch (InstantiationException e) {
                ActiveLog.e("Couldn't instantiate TypeSerializer.", e);
            } catch (IllegalAccessException e) {
                ActiveLog.e("IllegalAccessException", e);
